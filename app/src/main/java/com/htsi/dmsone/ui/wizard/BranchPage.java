...
import com.htsi.dmsone.ui.wizard.fragment.SingleChoiceFragment;
...
public class BranchPage extends SingleFixedChoicePage {
    ...
    public BranchPage(ModelCallbacks callbacks, String title, Report pReport) {
    ...
    public BranchPage addBranch(String key, String choice) {
