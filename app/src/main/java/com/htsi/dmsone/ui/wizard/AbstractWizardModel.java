 ...
 *
 * To create an actual wizard model, extend this class and implement {@link #onNewRootPageList(List<Report>)}.
 */
public abstract class AbstractWizardModel implements ModelCallbacks {
    ...
    public AbstractWizardModel(Context context, List<Report> pReportList) {
        mContext = context;
        mRootPageList = onNewRootPageList(pReportList);
    }

    /**
     * Override this to define a new wizard model.
     */
    protected abstract PageList onNewRootPageList(List<Report> pReportList);
